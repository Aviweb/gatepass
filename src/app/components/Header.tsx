...
export const Header = ({ role, userName }: props) => {
  ...
  return (
    <>
      <div
        className="bg-cover bg-right bg-fixed bg-no-repeat h-screen text-white hidden md:block"
        style={{
          ...
          <div className="header-content">
            {userName ? (
              ...
              <>
                ...
                <p className="lead">
                  A completely digital process to generate your gate pass and
                  get approved by hostel admin. Step towards paperless campus.{" "}
                </p>
              </>
            )}
          </div>
