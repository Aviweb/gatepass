              ...
              <tbody>
                {studentData?.map((entry, index) => (
                  ...
                  >
                    ...
                    <td className="text-center py-1">{entry?.name}</td>
                    <td className="text-center py-1">{entry?.roll_no}</td>
                    <td className="text-center py-1">{entry?.branch}</td>
                    <td className="text-center py-1">{entry?.hostel}</td>
                    <td className="text-center py-1">{entry?.phoneNo}</td>
                    <td className="text-center py-1">
                      {formatDateTimeToIST(entry?.created_at)?.time +
                        ", " +
                        formatDateTimeToIST(entry?.created_at)?.date}
                    </td>
                    {/* <td className="text-center py-1">
                      <a
                        href="#"
